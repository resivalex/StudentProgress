...
$student_names = "Арчинекова А. М.;Богатырев А. С.;Галаев А. И.;Дмитриев А. Е.;Иванов В. О.;Ильина Д. Е.;Кабанова К. В.;Копцева К. А.;Крыжановский М. Е.;Луценко А. Ю.;Митасова М. А.;Обарская Н. С.;Ольхова О. В.;Скребкова Е. В.;Суродина Е. С.;Шумилова Е. К.;Юдакова Е. А.
";
...
$student_list->setAttribute("width", "200px");
...
$div2->setAttribute("style", "width:500px;overflow-x:auto");
...
$div3->setAttribute("style", "width:215px;height:455px;overflow-y:auto");
...
$tr1 = $document->createElement("tr");
$td1 = $document->createElement("td", "08.05.2013 13:55:06");
$tr1->appendChild($td1);
$tab1->appendChild($tr1);
$tr1 = $document->createElement("tr");
...
$tab1->appendChild($tr1);
$tr1 = $document->createElement("tr");
$td1 = $document->createElement("td", "08.05.2013 13:41:35");
$tr1->appendChild($td1);
$tab1->appendChild($tr1);
$tr1 = $document->createElement("tr");
...
$cgt3->setAttribute("style", "widht:200px;height:476px");
